    ...
    if (navActions) {
       navActions.innerHTML = `
        <div class="user-profile-menu-container" style="position: relative;">
          ...
          <div id="account-dropdown" style="display: none; position: absolute; right: 0; top: 100%; margin-top: 8px; background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); width: 220px; z-index: 10000; overflow: hidden; padding: 12px 0; text-align: left; opacity: 0; transition: opacity 150ms ease;">
            ...
            <a href="#" id="signout-link" class="dropdown-item" style="color: #d93025 !important; font-weight: 600; border-top: 1px solid #e0e0e0; margin-top: 8px; padding: 12px 16px; display: block; text-decoration: none;">Sign Out</a>
          </div>
        </div>
      `;
...
// Global dismiss for dropdown
if (!window.dropdownCloserAdded) {
  ...
  window.dropdownCloserAdded = true;
}
